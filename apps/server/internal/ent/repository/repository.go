...
const (
	...
	FilesTable = "file_items"
	// FilesInverseTable is the table name for the FileItem entity.
	// It exists in this package in order to avoid circular dependency with the "fileitem" package.
	FilesInverseTable = "file_items"
	// FilesColumn is the table column denoting the files relation/edge.
	FilesColumn = "repository_files"
)
