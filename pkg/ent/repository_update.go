...
func (ru *RepositoryUpdate) SetPath(s string) *RepositoryUpdate {
	ru.mutation.SetPath(s)
	return ru
}

// SetNillablePath sets the "path" field if the given value is not nil.
func (ru *RepositoryUpdate) SetNillablePath(s *string) *RepositoryUpdate {
	if s != nil {
		ru.SetPath(*s)
	}
	return ru
...
// SetPath sets the "path" field.
func (ruo *RepositoryUpdateOne) SetPath(s string) *RepositoryUpdateOne {
	ruo.mutation.SetPath(s)
	return ruo
}

// SetNillablePath sets the "path" field if the given value is not nil.
func (ruo *RepositoryUpdateOne) SetNillablePath(s *string) *RepositoryUpdateOne {
	if s != nil {
		ruo.SetPath(*s)
	}
	return ruo
